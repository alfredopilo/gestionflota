...
export default function ImportVehiclesPage() {
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute('download', 'vehiculos_plantilla.xlsx');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let errorMessage = 'Error al importar los vehículos';
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Importar Vehículos</h1>
        <p className="mt-2 text-gray-600">
          Importa múltiples vehículos desde un archivo Excel
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm mb-3">
            Descarga la plantilla Excel y complétala con los datos de los vehículos a importar.
          </p>
          <button
            type="button"
